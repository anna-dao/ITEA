/* Задане натуральне число a, яке позначає місяць (4 – квітень). Треба попросити користувача ввести це число і отримати його в певній змінній. Потім перевірити чи можна цьому числу покласти у місяць року (вважається, що в році місяці пронумеровані з першого по дванадцятий), який вказано вище. І, якщо можна, то вивести цей місяць на екран; якщо ні, то вивести повідомлення, що вказаному числу не можна покласти у відповідність місяць. Результати записати у репозиторій на github.com. Лінк на репозиторій надіслати на перевірку. */
